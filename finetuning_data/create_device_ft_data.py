...
if __name__ == "__main__":
    ...
    REFERENCE_DIR = Path(os.path.join(os.path.expanduser("~"), DEFAULT_AI_INSTALL_DIR, "references", "examples"))
    OUTPUT_DIR = Path(os.path.join(os.path.expanduser("~"), DEFAULT_AI_INSTALL_DIR, "finetuning_data", "datasets", "devices"))
